...
# We do NOT need the manual checkpoint import here anymore.

class DIMTDAModel(PreTrainedModel):
    # This is a key property that tells the Trainer that this model CAN support gradient checkpointing
    # if the correct methods are implemented.
    ...
    def __init__(self, config, trans_model, dit_model, nougat_model, num_query_tokens, qformer_config_dir):
        ...
        self.dit_enc_to_dec_proj = nn.Linear(512, 512)
        self.nougat_enc_to_dec_proj = nn.Linear(1024, 512)
        self.trans_enc_to_dec_proj = nn.Linear(512, 512)
        ...
        qformer_config.intermediate_size = 1024
    ...
    def gradient_checkpointing_enable(self):
        ...
        This is the method that the Hugging Face Trainer calls automatically.
        """
        print("Enabling gradient checkpointing for DIMTDAModel sub-modules.")
    ...
    def forward(
        ...
        **kwargs,
        ...
        # This is the restored, original forward pass.
        # The Trainer will now handle applying checkpointing to these calls automatically.
